    ...
    >
      ...
      <div className="sticky top-0 z-30 h-screen w-full flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          <h1 className="hero-title font-cormorant-sc font-bold text-[48px] md:text-[80px] lg:text-[96px] text-dm-white-warm leading-none mb-4" style={textShadowStyle}>
            {t('title')}
          </h1>
          <p className="hero-tagline font-cormorant italic text-dm-gold-muted text-xl md:text-3xl mb-8" style={textShadowStyle}>
            {t('tagline')}
          </p>
          <div className="w-20 h-px bg-dm-gold-primary/40 mb-8" aria-hidden="true" />
          <p className="hero-established font-dm-sans font-light text-dm-white-ghost text-xs md:text-sm tracking-wider mb-10">
            {t('established')}
          </p>
          <ScrollIndicator />
        </motion.div>
        ...
        >
          <div className={`max-w-2xl ${beatCardStyle} text-center`}>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <a
                href="#products"
                className="group inline-flex items-center justify-center px-8 py-3.5 border border-dm-gold-primary/60 text-dm-gold-primary font-dm-sans font-light text-sm uppercase tracking-widest transition-all duration-[350ms] ease-luxury hover:border-dm-gold-primary hover:bg-dm-gold-primary/10 hover:shadow-[0_0_20px_rgba(212,175,55,0.15)] backdrop-blur-sm"
              >
                {t('cta_explore')}
              </a>
              <a
